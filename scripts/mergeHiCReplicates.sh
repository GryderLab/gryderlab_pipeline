...
${hicpro} HiC-Pro -i ${hic_home}/${merged_sample}/HiCproOUTPUT.hg19/hic_results/data -o ${hic_home}/${merged_sample}/HiCproOUTPUT.hg19 -c ${config_file} -s quality_checks -s merge_persample -s build_contact_maps -s ice_norm
${hicpro} /HiC-Pro-devel/bin/utils/hicpro2juicebox.sh -i ${dest_dir}/${merged_sample}.allValidPairs -g hg19 -j /usr/local/apps/juicer/juicer-1.5.6/scripts/juicer_tools.jar -o ${merged_sample}
